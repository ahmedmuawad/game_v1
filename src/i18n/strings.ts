...
export const strings = {
  ...
  'play.again':        { ar: 'كمان مرة', en: 'Play again' },
  'play.exit':         { ar: 'خلاص', en: 'Done' },
  'play.reward':       { ar: 'كسبتي', en: 'You earned' },
  'play.round':        { ar: 'جولة {n}', en: 'Round {n}' },
  'play.tapToStart':   { ar: 'المسي لما تبدأ', en: 'Tap when it lands' },
  'play.g.style_match.name': { ar: 'طابقي الستايل', en: 'Style Match' },
  'play.g.style_match.how':  { ar: 'هيجيلك وصف إطلالة — اختاري القطعة اللي تناسبها', en: 'You get a look brief — pick the piece that fits' },
  'play.g.style_match.brief': { ar: 'المطلوب النهاردة', en: "Today's brief" },
  'play.g.memory.name':      { ar: 'لعبة الذاكرة', en: 'Memory' },
  'play.g.memory.how':       { ar: 'اقلبي الكروت ولاقي الأزواج المتطابقة', en: 'Flip cards and find the matching pairs' },
  'play.g.quiz.name':        { ar: 'اختبار الستايل', en: 'Style Quiz' },
  'play.g.quiz.how':         { ar: 'أسئلة سريعة عن الستايل والقصة', en: 'Quick questions on style and story' },
  'play.g.rhythm.name':      { ar: 'خطوات الإيقاع', en: 'Rhythm Steps' },
  'play.g.rhythm.how':       { ar: 'المسي الدايرة لما توصل الخط', en: 'Tap the circle as it reaches the line' },
  'play.g.room_puzzle.name': { ar: 'رتّبي الغرفة', en: 'Room Puzzle' },
  'play.g.room_puzzle.how':  { ar: 'رجّعي كل قطعة لمكانها الصح', en: 'Put every piece back in its place' },
  'play.pairs':        { ar: 'أزواج', en: 'Pairs' },
  'play.correct':      { ar: 'صح', en: 'Correct' },
  'play.streakLabel':  { ar: 'متتالية', en: 'Streak' },

  // ===== أوسمة الستايل =====
  'style.tag.casual':  { ar: 'كاجوال', en: 'Casual' },
  'style.tag.soft':    { ar: 'ناعم', en: 'Soft' },
  'style.tag.bold':    { ar: 'جريء', en: 'Bold' },
  'style.tag.sporty':  { ar: 'رياضي', en: 'Sporty' },
  'style.tag.formal':  { ar: 'رسمي', en: 'Formal' },
  'style.tag.cozy':    { ar: 'دافي', en: 'Cozy' },
  'style.tag.dreamy':  { ar: 'حالم', en: 'Dreamy' },
  'style.tag.seasonal': { ar: 'موسمي', en: 'Seasonal' },
